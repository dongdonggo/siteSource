...
<head>
    ...
    <meta charset="utf-8" />
    <title>has 是否存在-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_has" class="on"><a href="doc.has.php">has</a></li>
...
</div><div id="main_body"><h3>has</h3><p class="desc">确定数据是否存在</p><div class="function_name">has($table, $where)</div><ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>where [array]</h5><p>WHERE 条件.</p></li></ul><div class="function_name">has($table, $join, $where)</div>        <ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>join [array]</h5><p>多表查询.</p></li><li><h5>where [array]</h5><p>WHERE条件.</p></li></ul><div class="function_return">Return: [boolean] 返回 TRUE 或者 FALSE.</div><div class="note">可用于做密码判断。</div><pre class="prettyprint linenums">if ($database->has("account", [    "AND" => [        "OR" => [            "user_name" => "foo",            "email" => "foo"        ],        "password" => "12345"    ]])){    echo "Password is correct.";}else{    echo "Password error.";}</pre></div></div><footer>
