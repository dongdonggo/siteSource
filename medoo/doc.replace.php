...
<head>
    ...
    <meta charset="utf-8" />
    <title>replace 替换-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_replace" class="on"><a href="doc.replace.php">replace</a></li>
...
</div><div id="main_body"><h3>replace</h3><p class="desc">将新的数据替换旧的数据</p>    <div class="function_name">replace($table, $column, $search, $replace, $where)</div>        <ul class="para_list">        <li><h5>table [string]</h5><p>表名.</p></li>        <li><h5>columns [string/array]</h5><p>The target columns of data will be replaced.</p></li>        <li><h5>search [string]</h5><p>The value being searched for.</p></li>        <li><h5>replace [string]</h5><p>The replacement value that replaces found search values.</p></li>        <li><h5>where (optional) [array]</h5><p>The WHERE clause to filter records.</p></li>        </ul>    <div class="function_name">replace($table, $column, $replacement, $where)</div>        <ul class="para_list">        <li><h5>table [String]</h5><p>表名.</p></li>        <li><h5>columns [string/array]</h5><p>The target columns of data will be replaced.</p></li>        <li><h5>replacement [array]</h5><p>The replacement array value that contained search value as key and replace string as value.</p></li>        <li><h5>where (optional) [array]</h5><p>The WHERE clause to filter records.</p></li>        </ul>    <div class="function_name">replace($table, $columns, $where)</div>        <ul class="para_list">        <li><h5>table [string]</h5><p>表名.</p></li>        <li><h5>columns [array]</h5><p>The target columns of data will be replaced.</p></li>        <li><h5>where (optional) [array]</h5><p>The WHERE clause to filter records.</p></li>        </ul><div class="function_return">Return: [number] 返回受影响的行数</div><pre class="prettyprint linenums">$database->replace("account", "type", "user", "new_user", [    "user_id[>]" => 1000]);$database->replace("account", "type", [    "user" => "new_user",    "business" => "new_business"], [    "user_id[>]" => 1000]);$database->replace("account", [    "type" => [        "user" => "new_user",        "business" => "new_business"    ],    "group" => [        "groupA" => "groupB"    ]], [    "user_id[>]" => 1000]);</pre>	</div></div><footer>
