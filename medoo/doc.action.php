...
<head>
    ...
    <meta charset="utf-8" />
    <title>action-事务-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<h4>Transaction</h4>
<ul class="api_list">
<li id="api_list_action" class="on"><a href="doc.action.php">action</a></li>
</ul>
...
</div><div id="main_body"><h3>Action(事务)</h3><p class="desc">启动一个事务</p><div class="function_name">action( $callback )</div><ul class="para_list"><li><h5>$callback [function]</h5><p>事务内执行的方法.</p></li></ul><div class="function_return">Return: void</div><div class="note">不是每个数据库引擎都支持事务。你必须在使用前检查。如果返回false，则回滚事务。</div><pre class="prettyprint linenums">$database->action(function($database) {    $database->insert("account", [        "name" => "foo",        "email" => "bar@abc.com"    ]);    $database->delete("account", [        "user_id" => 2312    ]);    // If you want to  find something wrong, just return false to rollback the whole transaction.    if ($database->has("post", ["user_id" => 2312]))    {        return false;    }});</pre>	</div></div><footer>
