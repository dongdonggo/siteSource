...
<head>
    ...
    <meta charset="utf-8" />
    <title>quote -Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_quote" class="on"><a href="doc.quote.php">quote</a></li>
</ul>
...
<div id="main_body"><h3>quote</h3><p class="desc">字符串转义</p><div class="function_name">quote($string)</div><ul class="para_list"><li><h5>$string [string]</h5><p>字符串.</p></li></ul><div class="function_return">Return: [string]</div><div class="note">Quote() 对字符串进行转义</div><pre class="prettyprint linenums">$data = "Medoo";echo "We love " . $data; // We love Medooecho "We love " . $database->quote($data); // We love 'Medoo'</pre>	</div></div><footer>
