...
<head>
    ...
    <meta charset="utf-8" />
    <title>query 查询-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<h4>原生SQL查询</h4>
<ul class="api_list">
<li id="api_list_query" class="on"><a href="doc.query.php">query</a></li>
...
<div id="main_body"><h3>query</h3><p class="desc">执行sql语句</p><div class="function_name">query($query)</div><ul class="para_list"><li><h5>query [string]</h5><p>The SQL query.</p></li></ul><div class="function_return">Return: [object] The PDOStatement object.</div><div class="note">此方法用于使用复杂的SQL语句，SQL注入问题请参考quote方法</div><pre class="prettyprint linenums">$database->query("CREATE TABLE table (	c1 INT STORAGE DISK,	c2 INT STORAGE MEMORY) ENGINE NDB;");$data = $database->query("SELECT email FROM account")->fetchAll();print_r($data);// Prepared statement// Medoo will auto-detect the data type for input parameters$data = $database->query(	"SELECT * FROM account WHERE user_name = :user_name AND age = :age", [		":user_name" => "John Smite",		":age" => 20	])->fetchAll();print_r($data);</pre>	</div></div><footer>
