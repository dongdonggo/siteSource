...
<head>
    ...
    <meta charset="utf-8" />
    <title>max 最大值-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_max" class="on"><a href="doc.max.php">max</a></li>
...
<div id="main_body"><h3>max</h3><p class="desc">获得数据表中，值最大的</p><div class="function_name">max($table, $column, $where)</div><ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>column [string]</h5><p>查询的字段列.</p></li><li><h5>where (optional) [array]</h5><p>WHERE 条件.</p></li></ul><div class="function_name">max($table, $join, $column, $where)</div>        <ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>join [array]</h5><p>多表查询.</p></li><li><h5>column [string]</h5><p>字段名.</p></li><li><h5>where (optional) [array]</h5><p>条件.</p></li></ul><div class="function_return">Return: [number] 返回最大的值.</div><div class="note">这个返回数值类型.</div><pre class="prettyprint linenums">$max = $database->max("account", "age", [    "gender" => "female"]);echo "The age of oldest female user is " . $max;</pre>	</div></div><footer>
