...
<head>
    ...
    <meta charset="utf-8" />
    <title>get-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_get" class="on"><a href="doc.get.php">get</a></li>
...
<div id="main_body"><h3>get</h3><p class="desc">从表中返回一行数据</p><div class="function_name">get($table, $columns, $where)</div><ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>columns [string/array]</h5><p>返回的字段列.</p></li><li><h5>where (optional) [array]</h5><p>WHERE 条件.</p></li></ul>    <div class="function_name">get($table, $join, $columns, $where)</div>    <ul class="para_list">        <li><h5>table [string]</h5><p>表名.</p></li>        <li><h5>join [array]</h5><p>表的关联,如果没有可忽略.</p></li>        <li><h5>columns [string/array]</h5><p>返回的字段列.</p></li>        <li><h5>where (optional) [array]</h5><p>WHERE 条件.</p></li>    </ul><div class="function_return">Return: [string/array] 返回查询到的数据.</div><div class="note">这个方法只能获取一条数据</div><pre class="prettyprint linenums">$email = $database->get("account", "email", [	"user_id" => 1234]);// $email = "foo@bar.com"$profile = $database->get("account", [	"email",	"gender",	"location"], [	"user_id" => 1234]);// $profile = array(// 	"email" => "foo@bar.com",// 	"gender" => "female",// 	"location" => "earth"// )$data = $database->get("post", [	"[>]account" => "user_id"], [	"post.content",	"account.user_name",	"account.location"], [	"ORDER" => "post.rate"]);// $data = array(// 	"content" => "A new day",// 	"user_name" => "foo",// 	"location" => "earth"// )</pre>	</div></div><footer>
