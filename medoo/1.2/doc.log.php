...
<head>
    ...
    <meta charset="utf-8" />
    <title>log-日志记录-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_log" class="on"><a href="doc.log.php">log</a></li>
