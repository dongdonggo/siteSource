...
<head>
    ...
    <meta charset="utf-8" />
    <title>error 错误调试Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_error" class="on"><a href="doc.error.php">error</a></li>
...
</div><div id="main_body"><h3>error</h3><p class="desc">获得最后一个执行的错误.</p><div class="function_name">error()</div><div class="function_return">Return: [array] 返回错误的数组代码</div><div class="note">输出值为数组</div><pre class="prettyprint linenums">$database->select("bccount", [    "user_name",    "email"], [    "user_id[<]" => 20]);var_dump($database->error());// array(3) { [0]=> string(5) "42S02" [1]=> int(1146) [2]=> string(36) "Table 'my_database.bccount' doesn't exist" }</pre>	</div></div><footer>
