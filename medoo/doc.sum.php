...
<head>
    ...
    <meta charset="utf-8" />
    <title>sum 求和-Medoo - 高效的轻量级PHP数据库框架, 提高开发效率！</title>
...
<li id="api_list_sum" class="on"><a href="doc.sum.php">sum</a></li>
</ul>
...
</div><div id="main_body"><h3>sum</h3><p class="desc">某个列字段相加</p><div class="function_name">sum($table, $column, $where)</div><ul class="para_list"><li><h5>table [string]</h5><p>表名.</p></li><li><h5>column [string]</h5><p>查询的列.</p></li><li><h5>where (optional) [array]</h5><p>WHERE 条件.</p></li></ul><div class="function_name">sum($table, $join, $column, $where)</div><ul class="para_list"><li><h5>table [string]</h5><p>The table name.</p></li><li><h5>join [array]</h5><p>Table relativity for table joining.</p></li><li><h5>column [string]</h5><p>The target column will be calculated.</p></li><li><h5>where (optional) [array]</h5><p>The WHERE clause to filter records.</p></li></ul><div class="function_return">Return: [number] 相加的值.</div><div class="note">The type of returned data is number.</div><pre class="prettyprint linenums">$total = $database->sum("account", "money");echo "We have $" . $total;</pre>	</div></div><footer>
